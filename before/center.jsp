	...
	<table width="900" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="center" valign="center" height="450">
				...
				<form action="${pageContext.request.contextPath }/updateUser?userName=${user.userName }" name="form1" method="post"
						...
						<table border="1" cellspacing="0" bordercolorlight="#C0C0C0"
							...
							<tr>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="right"><font color="#996633">用 户
										名：</font></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">${user.userName }</font>
								</td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
							...
							<tr>
								...
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									...
									type="password" name="userPwd" value="${user.userPwd }" /></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">&nbsp;*
							...
							<tr>
								...
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><input class="input7"
									type="password" name="qpwd" value="${user.userPwd }" /></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">&nbsp;*
								</font>请将输入的密码再次输入</td>
							</tr>
							<tr>
								...
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									...
									name="userRealname" value="${user.userRealname }" /></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">&nbsp;*
								</font>填写您的真实的姓名</td>
							</tr>
							<tr>
								...
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									...
									<font color="red">${user.userSex}</font> 
								</td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">&nbsp;*
								</font>请填写您的真实信息</td>
							...
							<tr>
								...
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><input class="input7" type="text"
									name="userAge" value="${user.userAge }" /></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">&nbsp;*
								</font>请输入您的真实年龄</td>
							</tr>
							<tr>
								...
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><input class="input7" type="text"
									name="userCard" value="${user.userCard }" /></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">&nbsp;*
								</font>请填写您的真实信息</td>
							</tr>
							<tr>
								...
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><input class="input7" type="text"
									name="userAddress" value="${user.userAddress }" /></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">&nbsp;*
								</font>请填写您的真实信息</td>
							</tr>
