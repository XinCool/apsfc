	...
	<table width="100%" height="1" border="0" cellpadding="0"
		...
		<tr>
			<td valign="top" bgcolor="#F7F8F9">
				<p>修改菜单</p>
				<div align="center">
					<form action="${pageContext.request.contextPath }/updMenus" method="post"
						...
						<table id="table2" class="line_table"
							...
							<tr>
								...
								<td class="line_table" height="25" width="70%"><input
									type="text" name="menusName" size="45" value="${menus.menusName }"></td>
							</tr>
							...
							<tr>
								...
								<td class="line_table" height="25" width="80%"><input
									type="text" name="menusBurden" size="45"
									value="${menus.menusBurden }"></td>
							</tr>
							<tr>
								<td class="line_table" height="25" align="right" width="20%"><span
									class="left_bt2">市场价格：</span></td>
								<td height="25" width="80%"><input type="text" name="menusPrice"
									size="45" value="${menus.menusPrice }"></td>
							</tr>
							<tr>
								<td class="line_table" height="25" align="right" width="20%"><span
									class="left_bt2">会员价格：</span></td>
								<td height="25" width="80%"><input type="text"
									name="menusPricel" size="45" value="${requestScope.menus.menusPricel }"></td>
							</tr>
							<tr>
								<td class="line_table" height="25" align="right" width="20%"><span
									class="left_bt2">说&nbsp;&nbsp;&nbsp; 明：</span></td>
								<td class="line_table" height="25" width="80%"><textarea
										rows="12" name="menusBrief" cols="100">${requestScope.menus.menusBrief }</textarea></td>
							</tr>
							<tr>
								<td class="line_table" height="25" align="right" width="20%"><span
							...
							<tr>
								...
								<td class="line_table" width="80%" align="left"><img
									src="${pageContext.request.contextPath }/${menus.menusImgpath }">
									<input type="hidden" name="menusId" value="${menus.menusId }"/></td>
							</tr>
