...
<script type="text/javascript">
	 function verifyInfo() {
		//用户名
		if(!verifyUserName(document.form1.userName.value)) {
			alert("请按要求填写用户名");
			return false;
		}
		//密码
		if(!verifyPwd(document.form1.userPwd.value)) {
			alert("请按照要求填写密码");
			return false;
		}
		//两次密码相同
		if(!verifyConfirmPwd(document.form1.userPwd.value, document.form1.qpwd.value)) {
			alert("请保证两次输入的密码一致");
			return false;
		}
		//真实姓名
		if(!verifyName(document.form1.userRealname.value)) {
			alert("请按要求输入真实姓名");
			return false;
		}
		//年龄
		if(!verifyAge(document.form1.userAge.value)) {
			alert("请按要求输入年龄");
			return false;
		}
		//身份证号
		if(!verifyID(document.form1.userCard.value)) {
			alert("请按要求输入身份证号");
			return false;
		}
		//家庭地址
		if(!verifyNotNull(document.form1.userAddress.value)) {
			alert("家庭住址不能为空");
			return false;
		}
		//电话号码
		if(!verifyTel(document.form1.userPhone.value)) {
			alert("请按要求输入电话号码");
			return false;
		}
		//电子邮箱
		if(!verifyEmail(document.form1.userEmail.value)) {
			alert("请按要求输入电子邮箱");
			return false;
		}
		//邮政编码
		if(!verifyPostcode(document.form1.userCode.value)) {
			alert("请按要求输入邮政编码");
			return false;
		}
	} 
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <form action="${pageContext.request.contextPath }/regUser" name="form1" method="post" onsubmit="return verifyInfo()">
  ...
  <table border="1" cellspacing="0" bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" width="700">
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="text" name="userName"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left" >
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="pwd" name="userPwd"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="text" name="userRealname"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="text" name="userAge"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="text" name="userCard"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<font color="red">&nbsp;* </font>请填写您的真实信息
					</td>
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="text" name="userAddress"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<font color="red">&nbsp;* </font>请填写您的真实信息
					</td>
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="text" name="userPhone"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="text" name="userEmail"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
				...
				<tr>
					...
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
						<input class="input7" type="text" name="userCode"/>
					</td>
					<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" height="25" align="left">
