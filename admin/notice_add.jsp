...
<script type="text/javascript">
	function verifyInfo() {
		//公告标题
		if(!verifyNotNull(document.form1.noticeName.value)) {
			alert("公告标题不能为空");
			return false;
		}
		//公告内容
		if(!verifyNotNull(document.form1.noticeContent.value)) {
			alert("公告内容不能为空");
			return false;
		}
	}
