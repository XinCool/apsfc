<%@page import="com.hpe.vo.DayInfo"%>
...
<link href="${pageContext.request.contextPath }/qiantai/css/dingcanall.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath }/qiantai/css/newslist_time2.css" rel="stylesheet" type="text/css" />	
<link href="${pageContext.request.contextPath }/qiantai/css/dingcanche.css" rel="stylesheet" type="text/css" />	
<link href="${pageContext.request.contextPath }/qiantai/css/dingcanweekmenu.css" rel="stylesheet" type="text/css" />	
<script type="text/javascript" src="${pageContext.request.contextPath }/qiantai/js/jquery-1.7.2.min.js" ></script>								
</head>
...
<body style='background: transparent'>
	<table width="900" border="0" align="center" cellpadding="0"
		cellspacing="0">
		<tr>
			<td align="left" valign="top"><jsp:include flush="false" page="top.jsp" /></td>
		</tr>
		<tr>
			<td height="30"></td>
														...
														<table>
																		...
																		<table>
																			...
																			<tr>
																				<td colspan="2" style="height: 40px;"><a
																					href="${pageContext.request.contextPath}/FrontServlet?action=isLogin&type=shoppingCar&cart=add&menusName=${item.menusName }">加入餐车</a></td>
																				<td></td>
																			</tr>
																		</table>
																	</div>
															...
															<tr>
																...
																<span class="left_bt2">第${currentPage.curPage }页
																    ...
																    <a href="${pageContext.request.contextPath}/FrontServlet?action=getMenusByPage&curPage=1">[首页]</a>
																    <a href="${pageContext.request.contextPath}/FrontServlet?action=getMenusByPage&curPage=${currentPage.totalPage}">[尾页]</a>&nbsp;&nbsp; 
																   
																	<c:if test="${currentPage.curPage != 1}">
																		<a href="${pageContext.request.contextPath}/FrontServlet?action=getMenusByPage&curPage=${currentPage.curPage-1}">[上一页]</a>									
																	</c:if>	   
																	<c:if test="${currentPage.curPage == 1}">
																    ...
																    <c:if test="${currentPage.curPage != currentPage.totalPage }">
																		<a href="${pageContext.request.contextPath}/FrontServlet?action=getMenusByPage&curPage=${currentPage.curPage+1}">[下一页]</a>
																	</c:if>
								...
								<tr>
									<td valign="top"><div id='pdv_' class='pdv_class' title='网站公告'
											...
											<div id='spdv_3603' class='pdv_content'
												...
												<div class="pdv_border"
													style="border: 0px; height: 100%; padding: 0; margin: 0; background: url(${pageContext.request.contextPath}/qiantai/images/left.jpg) repeat-y">
													<div
														style="height: 100%; background: url(${pageContext.request.contextPath}/qiantai/images/right.jpg) right repeat-y">
														<div
															...
															<div
																...
																<a href="${pageContext.request.contextPath }/qiantai/notice.jsp"
															...
															<ul class="newslist_time2">
																<c:forEach var="item" items="${notices }" begin="0" end="1">
																	<li class="newslist_time2">
																		...
																		<a href="${pageContext.request.contextPath }/FrontServlet?action=showNotice&name=${item.noticeName }" class="newslist_time2">${item.noticeName }</a>
																	</li>
																</c:forEach>
															</ul>
												...
												<div
													style="margin-top: -10px; height: 10px; line-height: 10px; background: url(${pageContext.request.contextPath }/qiantai/images/bg.jpg) 0px -220px no-repeat">&nbsp;</div>
												<div
													style="float: right; margin-top: -10px; width: 10px; height: 10px; line-height: 10px; background: url(${pageContext.request.contextPath }/qiantai/images/bg.jpg) -890px -220px no-repeat">&nbsp;</div>
											</div>
										</div></td>
								</tr>
								<tr>
															...
															<div id="dingcanche2">
																...
																<table width="100%" border="0" cellspacing="0"
																	...
																	<c:forEach var="i" items="${cart}">
																		<tr>
																			<td align="center">${i.menusName }</td>
																			<td align="center">${i.menusPricel }</td>
																			<td align="center">${i.orderMenusum }</td>
																			<td align="center"><a
																				href="${pageContext.request.contextPath }/FrontServlet?action=cart&type=deleteCart&menusName=${i.menusName}">取消</a></td>
																		</tr>
																	</c:forEach>
																...
																<c:forEach var="i" items="${cart}">${j }
																	<span style="display:none">${ sum=sum+i.sumMoney }${count=count+i.orderMenusum}</span>
																</c:forEach>
																<div style="height: 24px; margin: 5px 3px 1px 3px;">
																	...
																	<div
																		...
																		<font id="cpprice" style="color: #ff0000;"><c:if test="${sum == null}">0.0</c:if>
																		<c:if test="${sum != null}">${sum }</c:if></font>元
																	</div>
																</div>
																	...
																	<table width="100%" border="0" cellspacing="0">
																		<tr>
																			...
																			<td align="center" width="40%"><a
																				href="${pageContext.request.contextPath }/FrontServlet?action=cart&type=add"><img
																					src="${pageContext.request.contextPath }/qiantai/images/canche_submit.gif" border="0" /></a></td>
																			<td align="center" width="40%"><a
																				href="${pageContext.request.contextPath }/FrontServlet?action=cart&type=deleteAll"><img
																					src="${pageContext.request.contextPath }/qiantai/images/quxiao2.gif" border="0" /></a></td>
																		</tr>
																	</table>
																...
																<div style="padding: px;">
																	<div class="dingcanweekmenuinfo" align="left">
																		<c:forEach var="item" items="${sales }" begin="0" end="2">
																			<li class="newslist_time2"><div class="time">已销售${item.sumSale }次</div>
																			<a href="${pageContext.request.contextPath }/FrontServlet?action=showMenu&menusName=${item.menusName}" class="newslist_time2">${item.menusName }</a></li>
																		</c:forEach>
																	</div>
																</div>
															</div>
